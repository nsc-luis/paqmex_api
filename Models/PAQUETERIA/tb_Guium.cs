...
public partial class tb_Guium
{
    ...
    public string? RecibeEnt { get; set; }

    public DateOnly? FechaEnt { get; set; }

    public string? HoraEnt { get; set; }

    public bool? ProdQuim { get; set; }

    public byte? TipoSeguro { get; set; }

    public string? RespProdQuim { get; set; }

    public bool? DoctosAnexos { get; set; }

    public string? DescDocsAnexos { get; set; }

    public string? CuentaPago { get; set; }

    public string? BancoPago { get; set; }

    public byte? cve_anotacion { get; set; }

    public double? ValorFacCte { get; set; }

    public string? NumFacCte { get; set; }

    public string? CodigoRastreo { get; set; }

    public bool? EntregaApp { get; set; }
    ...
    public double? ImpDescFlete { get; set; }
    ...
    public long? CVE_VALIJA { get; set; }

    public int? cve_AgeVta { get; set; }

    public bool? AuditaCan { get; set; }

    public string? UsuAuditaCan { get; set; }

    public byte? Origen { get; set; }

    public string? CodRastreoCte { get; set; }
    ...
    public string? UUIDSustituye { get; set; }

    public string? MotivoCancelaSat { get; set; }
