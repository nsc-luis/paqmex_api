...
public partial class tb_caja
{
    public string num_caja { get; set; } = null!;
    ...
    public long? CVE_CAJAESTATUS { get; set; }
    ...
    public int? cve_TipoRemolSAT { get; set; }

    public string? cveSAT_TipoRemolSAT { get; set; }
